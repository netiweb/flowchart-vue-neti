module.exports = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ "1aaf": /***/ function (module, exports, __webpack_require__) {
...
*/
    ...
    /***/ "27ee": /***/ function (module, exports, __webpack_require__) {
      ...
      var ITERATOR = __webpack_require__("2b4c")("iterator");
      var Iterators = __webpack_require__("84f2");
      module.exports = __webpack_require__("8378").getIteratorMethod =
        function (it) {
          if (it != undefined)
    ...
    /***/ "369f": /***/ function (
      ...
      /* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_index_css_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default =
        /*#__PURE__*/ __webpack_require__.n(
          _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_index_css_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__
        );
...
*/
    ...
    /***/ "50c4": /***/ function (module, exports, __webpack_require__) {
      ...
      var update = add("3d8912d2", content, true, {
        sourceMap: false,
        shadowMode: false,
      });
    ...
    /***/ "5df3": /***/ function (module, exports, __webpack_require__) {
      "use strict";

      var $at = __webpack_require__("02f4")(true);

      // 21.1.3.27 String.prototype[@@iterator]()
      __webpack_require__("01f9")(
        String,
        "String",
        function (iterated) {
          this._t = String(iterated); // target
    ...
    /***/ "84b4": /***/ function (module, exports, __webpack_require__) {
    ...
    /***/ c7c6: /***/ function (module, exports, __webpack_require__) {
    ...
    /***/ fb15: /***/ function (
        ...
        return _c(
          "div",
          {
            ...
            on: {
              ...
              mousewheel: _vm.handleChartMouseWheel,
          ...
          [
            _c(
              "span",
              { staticClass: "unselectable", attrs: { id: "position" } },
              [
                _vm._v(
                  "\n    " +
                    _vm._s(
                      _vm.cursorToChartOffset.x +
                        ", " +
                        _vm.cursorToChartOffset.y
                    ) +
                    "\n  "
                ),
              ]
            ...
            _c(
              "div",
              { staticClass: "unselectable", attrs: { id: "chart-slot" } },
              [_vm._t("default")],
              2
            ),
          ]
      ...
      // CONCATENATED MODULE: ./src/components/flowchart/Flowchart.vue?vue&type=template&id=f5ca651c&
      ...
      function pointRectangleIntersection(p, r) {
        return (
          p.x > r.start.x && p.x < r.end.x && p.y > r.start.y && p.y < r.end.y
        );
      }
      ...
      /* harmony default export */ var on = function (
        typename,
        value,
        capture
      ) {
      ...
      /* harmony default export */ var join = function (
        onenter,
        onupdate,
        onexit
      ) {
      ...
      /* harmony default export */ var style = function (
        name,
        value,
        priority
      ) {
      ...
      /* harmony default export */ var src_touch = function (
        node,
        touches,
        identifier
      ) {
      ...
      /* harmony default export */ var src_drag = function () {
        ...
        function beforestart(id, container, point, that, args) {
          ...
          if (
            !customEvent(
              ...
              function () {
                if ((on_event.subject = s = subject.apply(that, args)) == null)
                  return false;
                dx = s.x - p[0] || 0;
                dy = s.y - p[1] || 0;
                return true;
        ...
        drag.filter = function (_) {
          return arguments.length
            ? ((filter = typeof _ === "function" ? _ : src_constant(!!_)), drag)
            : filter;
        };

        drag.container = function (_) {
          return arguments.length
            ? ((container = typeof _ === "function" ? _ : src_constant(_)),
              drag)
            : container;
        };
        ...
        drag.subject = function (_) {
          return arguments.length
            ? ((subject = typeof _ === "function" ? _ : src_constant(_)), drag)
            : subject;
        };

        drag.touchable = function (_) {
          return arguments.length
            ? ((touchable = typeof _ === "function" ? _ : src_constant(!!_)),
              drag)
            : touchable;
        };
      ...
      function render_render(g, node, isSelected) {
        ...
        var headerBackgroundColor = theme.headerBackgroundColor
          ...
          : "#f1f3f4";
        var bodyBackgroundColor = theme.bodyBackgroundColor
          ? theme.bodyBackgroundColor
          : "white";
        var bodyTextColor = theme.bodyTextColor ? theme.bodyTextColor : "black";
        var headerTextColor = theme.headerTextColor
      ...
      /* harmony default export */ var Flowchartvue_type_script_lang_js_ = {
        ...
        methods: {
          ...
          editConnection: function editConnection(connection) {
            if (
              this.readonly &&
              !this.readOnlyPermissions.allowEditConnections
            ) {
              return;
            }
                    ...
                    while (1) {
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          if (this.moveInfo) {
                            this.moveCoordinates.diffX -=
                              event.pageX - this.moveCoordinates.startX;
                            this.moveCoordinates.diffY +=
                              event.pageY - this.moveCoordinates.startY;
                            this.$emit("movediff", {
          ...
          isNodesConnectionValid: function isNodesConnectionValid() {
            ...
            var connectionToItself =
              this.connectingInfo.source.id === this.hoveredConnector.node.id;
            var connectionAlreadyExists = this.internalConnections.some(
              function (x) {
                return (
                  x.source.id === _this.connectingInfo.source.id &&
                  x.source.position === _this.connectingInfo.sourcePosition &&
                  x.destination.id === _this.hoveredConnector.node.id &&
                  x.destination.position === _this.hoveredConnector.position
                );
              }
            );
                    ...
                    while (1) {
                      switch ((_context2.prev = _context2.next)) {
                        ...
                        case 8:
                          ...
                          for (
                            _iterator = document
                              .querySelectorAll("#svg .connector")
                              [Symbol.iterator]();
                        ...
                        case 27:
                          sourceOffset = this.getNodeConnectorOffset(
                            this.connectingInfo.source.id,
                            this.connectingInfo.sourcePosition
                          );
                          destinationPosition = this.hoveredConnector
          ...
          initializeMovingAllElements: function initializeMovingAllElements(
            event
          ) {
          ...
          isMouseOverAnyNode: function isMouseOverAnyNode() {
            ...
            for (
              ...
              currentNodeIndex < this.internalNodes.length;
              currentNodeIndex++
            ) {
              ...
              var mousePointIntersectNodeArea =
                cursorPosition.x >= nodeArea.start.x &&
                cursorPosition.x <= nodeArea.end.x &&
                cursorPosition.y >= nodeArea.start.y &&
                cursorPosition.y <= nodeArea.end.y;
          ...
          renderSelection: function renderSelection() {
            ...
            if (that.selectionInfo) {
              ...
              try {
                for (
                  var _iterator2 = document
                      .querySelectorAll("#svg .selection")
                      [Symbol.iterator](),
                    _step2;
              ...
              that.lines.forEach(function (line) {
                ...
                if (
                  ...
                  var connection = that.internalConnections.filter(function (
                    conn
                  ) {
          ...
          renderConnections: function renderConnections() {
            ...
            return new Promise(function (resolve) {
              that.$nextTick(function () {
                ...
                try {
                  for (
                    var _iterator4 = document
                        .querySelectorAll("#svg > g.connection")
                        [Symbol.iterator](),
                      _step4;
                ...
                that.internalConnections.forEach(function (conn) {
                  ...
                  var sourcePosition = that.getNodeConnectorOffset(
                    conn.source.id,
                    conn.source.position
                  );
                  var destinationPosition = that.getNodeConnectorOffset(
                    conn.destination.id,
                  ...
                  if (
                    that.currentConnections.filter(function (item) {
                      return item === conn;
                    }).length > 0
                  ) {
                    colors = {
                  ...
                  try {
                    for (
                      var _iterator5 = result.paths[Symbol.iterator](), _step5;
                  ...
                  try {
                    for (
                      var _iterator6 = result.lines[Symbol.iterator](), _step6;
          ...
          haveNodesSelectedConnectors: function haveNodesSelectedConnectors(
            connection
          ) {
          ...
          renderNodes: function renderNodes() {
            ...
            return new Promise(function (resolve) {
              ...
              that.internalNodes.forEach(function (node) {
                that.renderNode(
                  node,
                  that.currentNodes.filter(function (item) {
                    return item === node;
                  }).length > 0
                );
              });
          ...
          getNodeConnectorOffset: function getNodeConnectorOffset(
            nodeId,
            connectorPosition
          ) {
          ...
          renderNode: function renderNode(node, isSelected) {
            ...
            var dragHandler = src_drag()
              .on("start", function () {
                // handle mousedown
                var isNotCurrentNode =
                  that.currentNodes.filter(function (item) {
                    return item === node;
                  }).length === 0;
                          ...
                          switch ((_context3.prev = _context3.next)) {
                            case 0:
                              if (
                                !(
                                  that.readonly &&
                                  !that.readOnlyPermissions.allowDragNodes
                                )
                              ) {
                                _context3.next = 2;
                                break;
                            ...
                            case 2:
                              ...
                              for (
                                _iterator8 =
                                  that.currentNodes[Symbol.iterator]();
                            ...
                            case 22:
                              ...
                              for (
                                _iterator9 = document
                                  .querySelectorAll("#svg > g.guideline")
                                  [Symbol.iterator]();
                            ...
                            case 41:
                              ...
                              expectX =
                                Math.round(Math.round(edge.start.x) / 10) * 10;
                              expectY =
                                Math.round(Math.round(edge.start.y) / 10) * 10;
                              that.internalNodes.forEach(function (item) {
                                if (
                                  that.currentNodes.filter(function (
                                    currentNode
                                  ) {
              ...
              .on("end", function () {
                ...
                try {
                  for (
                    var _iterator11 = that.currentNodes[Symbol.iterator](),
                      _step11;
                    !(_iteratorNormalCompletion11 = (_step11 =
                      _iterator11.next()).done);
                    _iteratorNormalCompletion11 = true
                  ) {
                    var currentNode = _step11.value;
                    currentNode.x =
                      Math.round(Math.round(currentNode.x) / 10) * 10;
                    currentNode.y =
                      Math.round(Math.round(currentNode.y) / 10) * 10;
                  }
                } catch (err) {
          ...
          getCurrentNodesEdge: function getCurrentNodesEdge() {
            ...
            points.push.apply(
              points,
              _toConsumableArray(
                this.currentNodes.map(function (node) {
                  return {
                    x: node.x + node.width,
                    y: node.y + node.height,
                  };
                      ...
                      switch ((_context4.prev = _context4.next)) {
                        case 0:
                          if (
                            !(
                              this.readonly &&
                              !this.readOnlyPermissions.allowRemove
                            )
                          ) {
                            _context4.next = 2;
                            break;
                        ...
                        case 2:
                          anyElementToRemove =
                            this.currentConnections.length > 0 ||
          ...
          removeSelectedNodesAndConnections:
            function removeSelectedNodesAndConnections() {
              if (this.readonly) {
                return;
              }
              ...
              if (this.currentConnections.length > 0) {
                ...
                try {
                  for (
                    var _iterator12 =
                        this.currentConnections[Symbol.iterator](),
                      _step12;
              ...
              if (this.currentNodes.length > 0) {
                ...
                try {
                  for (
                    var _iterator13 = this.currentNodes[Symbol.iterator](),
                      _step13;
          ...
          removeNode: function removeNode(node) {
            var connections = this.internalConnections.filter(function (item) {
              return (
                item.source.id === node.id || item.destination.id === node.id
              );
            });
            ...
            try {
              for (
                var _iterator14 = connections[Symbol.iterator](), _step14;
          ...
          moveCurrentNode: function moveCurrentNode(x, y) {
            if (this.currentNodes.length > 0 && !this.readonly) {
              ...
              try {
                for (
                  var _iterator15 = this.currentNodes[Symbol.iterator](),
                    _step15;
            ...
            switch (event.keyCode) {
              ...
              case 65:
                if (
                  ...
                  (_that$currentNodes = that.currentNodes).push.apply(
                    _that$currentNodes,
                    _toConsumableArray(that.internalNodes)
                  );

                  (_that$currentConnecti = that.currentConnections).push.apply(
                    _that$currentConnecti,
                    _toConsumableArray(that.internalConnections)
                  );
        ...
        computed: {
          hoveredConnector: function hoveredConnector() {
            ...
            try {
              for (
                var _iterator16 = this.internalNodes[Symbol.iterator](),
                  _step16;
          ...
          hoveredConnection: function hoveredConnection() {
            ...
            try {
              var _loop2 = function _loop2() {
                ...
                var distance = distanceOfPointToLine(
                  line.sourceX,
                  line.sourceY,
                  line.destinationX,
                  line.destinationY,
                  _this3.cursorToChartOffset.x,
                  _this3.cursorToChartOffset.y
                );
                ...
                if (
                  ...
                  var connections = _this3.internalConnections.filter(function (
                    item
                  ) {
                    return item.id === line.id;
                  });
              ...
              for (
                var _iterator17 = this.lines[Symbol.iterator](), _step17;
      ...
      /* harmony default export */ var flowchart_Flowchartvue_type_script_lang_js_ =
        Flowchartvue_type_script_lang_js_;
      // EXTERNAL MODULE: ./src/components/flowchart/index.css?vue&type=style&index=0&lang=css&
      var flowchartvue_type_style_index_0_lang_css_ =
        __webpack_require__("369f");
